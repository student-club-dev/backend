...
export const ERROR_CODE = {
  ...
  // student listings (STUDENT_LISTINGS_BACKEND.md §8). LISTING_NOT_FOUND above is reused —
  // "the listing does not exist" means the same thing to a client either way.
