...
/**
 * Phone verification for the provider app (D1). Guard-protected — the account comes from the access
 * token; `OtpService` is bound to the `business_owners` table. IP-throttled on top of the per-phone limits.
 */
